...
//
////The Surface contained by the window. The SDL_Surfaces are both pointers it's better to reference an image
//// by memory location. Imagine you had a game with a brick wall that consisted of the same brick image being 
//// rendered multiple times (like Super Mario Bros). It's wasteful to have dozens of copies of the image in 
